...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Execution', async function () {
        ...
        const AttackContractFactory = await ethers.getContractFactory('AttackNaiveReceiver', player);
        await AttackContractFactory.deploy(pool.address, receiver.address);
    });
